...
type Renderer interface {
	RenderTemplate(w http.ResponseWriter, tmpl string, data interface{}) error
}
...
func (h *HomeHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	if err := h.renderer.RenderTemplate(w, "home.page.tmpl", nil); err != nil {
...
func (h *AboutHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	if err := h.renderer.RenderTemplate(w, "about.page.tmpl", nil); err != nil {
...
func (h *UserHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	if err := h.renderer.RenderTemplate(w, "user.page.tmpl", nil); err != nil {
		// Error response already sent by renderer
